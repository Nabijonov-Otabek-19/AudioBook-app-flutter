...
class BookModel {
  ...
  BookModel.fromJson(Map jsonBook)
  ...
  static List<BookModel> fromJsonArray(List jsonBook) {
  ...
  static List<BookModel> fromDbArray(List jsonBook) {
    List<BookModel> books = <BookModel>[];
    for (var book in jsonBook) {
      books.add(BookModel.fromDB(book));
    }
    return books;
  }
